...
const Training = () => {
    ...
    // Stany do bazy danych
    const [totalAttempts, setTotalAttempts] = useState(0);
    const [trainingStartTime, setTrainingStartTime] = useState(null);

    // Referencje dla kamer
    ...
    // Mikrofon
    useVoiceCommand(handleFinishTraining, handleStartTraining, speak);

    // 3. Wysyłanie uśrednionych klatek
    const sendLandmarksToAPI = (landmarks, cameraView) => {
        ...
        const payload = {
            camera: cameraView,
            exerciseType: passType, // To mówi backendowi jakiego trenera odpalić!
            timestamp: now,
    ...
    // Front startuje natychmiast (0 ms opóźnienia)
    ...
    // Bok startuje z opóźnieniem 1.5 sekundy (1500 ms), omijając błąd serwerów Google
